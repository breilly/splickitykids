...
class KidsControllerTest < ActionController::TestCase
  ...
  test "should create kid" do
    assert_difference('Kid.count') do
      post :create, kid: { dob: @kid.dob, first_name: @kid.first_name, last_name: @kid.last_name, user_id: @kid.user_id }
    end
  ...
  test "should update kid" do
    patch :update, id: @kid, kid: { dob: @kid.dob, first_name: @kid.first_name, last_name: @kid.last_name, user_id: @kid.user_id }
    assert_redirected_to kid_path(assigns(:kid))
  end
